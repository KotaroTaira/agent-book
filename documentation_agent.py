# -*- coding: utf-8 -*-
"""documentation_agent.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VCzTdBg6-_-jE6vOUmuRQ-T3JWeaOPFX
"""
...
class PersonaGenerator:
    ...
    def run(self, user_request: str) -> Personas:
        prompt = ChatPromptTemplate.from_messages(
            [
                ("system", "あなたはユーザーインタビュー用の多様なペルソナを作成する専門家です。"),
    ...
    def _generate_questions(self, user_request: str, personas: list[Persona]) -> list[str]:
        question_prompt = ChatPromptTemplate.from_messages(
            [
                ...
                ("human",
                 "以下のペルソナに関連するユーザーリクエストについて1つの質問を生成してください。\n\n"
                 "ユーザーリクエスト: {user_request}\n"
    ...
    def run(self, user_request: str, interviews: list[Interview]) -> str:
        prompt = ChatPromptTemplate.from_messages(
            [
                ...
                ("human",
                 "以下のユーザーリクエストと複数のペルソナのインタビュー結果に基づいて、要件文書を作成してください。\n\n"
                 "ユーザーリクエスト: {user_request}\n\n"
                 "インタビュー結果:\n{interview_results}\n"
...
class DocumentationAgent:
    ...
    def _generate_personas(self, state: InterviewState) -> InterviewState:
    ...
    def _conduct_interviews(self, state: InterviewState) -> InterviewState:
        new_interviews: InterviewResult = self.interview_conductor.run(
            state.user_request, state.personas[-self.persona_generator.k:]
        )
        return {"interviews": new_interviews.interviews}

    def _evaluate_information(self, state: InterviewState) -> InterviewState:
        ...
        return {
            ...
            "evaluate_reason": evaluation_result.reason
        }

    def _generate_requirements(self, state:InterviewState) -> InterviewState:
